...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Filem>>{
    ...
    private String URL = "https://api.themoviedb.org/3/movie/now_playing?api_key=1ff901f7dde5dced18385c8b57bbabf9&region=US";
